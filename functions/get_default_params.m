function default_params = get_default_params
    ...
    default_params.training_function = @update_svm;
    ...
    init_params.features = @features;
    init_params.sbin = 8;
    init_params.goal_ncells = 100;
    init_params.MAXDIM = 12;
    init_params.init_function = @initialize_goalsize_exemplar;
